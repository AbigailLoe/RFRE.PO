...
# old versions of htree can be downloaded from CRAN. It has been retired with newer
# versions of R.
...
imputed_analysis_timeVarying = function() {
    ...
    c.plot = ggplot(total.res)+  
        ...
        labs(title = "Time-Varying C-Statistic with 95% Boostrap Confidence Interval",
    ...
    ggsave(plot = c.plot, width = 10, height = 8)
    ggsave(plot = c.plot, width = 10, height = 8)
    ggsave(plot = c.plot, width = 10, height = 8)
    ...
    mse.plot = ggplot(total.res)+
        ...
        labs(title = "Time-Varying MSE with 95% Boostrap Confidence Interval",
             x = "Follow-up Window Start-Time",
             y = "MSE")+
        theme(
            legend.position = "bottom"
    ...
    ggsave(plot = mse.plot, width = 10, height = 8)
    ggsave(plot = mse.plot,width = 10, height = 8)
    ggsave(plot = mse.plot,width = 10, height = 8)
